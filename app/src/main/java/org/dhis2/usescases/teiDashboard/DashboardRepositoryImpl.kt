...
class DashboardRepositoryImpl(
    ...
    override fun programHasRelationships(): Boolean {
        val countPrograms =  d2.programModule().programs().count().blockingGet()
        Timber.d("Programs: $countPrograms")
    ...
    override fun programHasAnalytics(): Boolean {
        //Trace about all programs
        val countProgramRules =  d2.programModule().programRules().count().blockingGet()
        Timber.d("programRules: $countProgramRules")
        val countProgramRuleActions =  d2.programModule().programRuleActions().count().blockingGet()
        Timber.d("programRuleActions: $countProgramRuleActions")
        val countProgramIndicators =  d2.programModule().programIndicators().count().blockingGet()
        Timber.run { d("programIndicators: $countProgramIndicators") }
