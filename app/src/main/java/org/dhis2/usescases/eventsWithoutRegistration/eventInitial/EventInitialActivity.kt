...
class EventInitialActivity :
    ...
    private var disableSelectOrgUnit = false
    ...
    private fun initVariables() {
        ...
        disableSelectOrgUnit =
            intent.getBooleanExtra(Constants.DISABLE_SELECT_ORG_UNIT, disableSelectOrgUnit)
    }
