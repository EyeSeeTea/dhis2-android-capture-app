...
open class App : Application(), Components, DefaultLifecycleObserver {
    ...
    // EyeSeeTea customization - Change Server URL
    // Replaces the releaseSessionComponent() call the dialog used to make: upstream removed
    // SessionComponent, and the dialog should release its own subcomponent anyway.
