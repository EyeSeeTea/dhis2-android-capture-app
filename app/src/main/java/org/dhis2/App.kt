...
open class App : Application(), Components, DefaultLifecycleObserver {
    ...
    // EyeSeeTea customization - Change Server URL
    fun createChangeServerULComponent(changeServerURLModule: ChangeServerURLModule): ChangeServerURLComponent {
        return (userComponent!!.plus(changeServerURLModule).also { changeServerURLComponent = it })
    }
}
