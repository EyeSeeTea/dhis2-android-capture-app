...
class DhisProgramUtils
    ...
    constructor(
        ...
        private fun hasTeiWithSMSState(teiRepository: TrackedEntityInstanceCollectionRepository): Boolean =
            teiRepository
                .byDeleted()
                .isFalse
                .byAggregatedSyncState()
                .`in`(State.SENT_VIA_SMS, State.SYNCED_VIA_SMS)
                .blockingGet()
                .isNotEmpty()

        private fun hasTeiWithNotSyncedStateOrDeleted(teiRepository: TrackedEntityInstanceCollectionRepository): Boolean =
            teiRepository
                .byDeleted()
                .isFalse
                .byAggregatedSyncState()
                .`in`(State.TO_UPDATE, State.TO_POST, State.UPLOADING)
                .blockingGet()
                .isNotEmpty() ||
                teiRepository
                    .byDeleted()
        ...
        private fun hasEventWithNotSyncedStateOrDeleted(eventRepository: EventCollectionRepository): Boolean =
            eventRepository
                .byDeleted()
                .isFalse
                .byAggregatedSyncState()
