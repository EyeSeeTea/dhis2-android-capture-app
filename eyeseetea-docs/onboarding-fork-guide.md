...
- `eyeseetea-docs/templates/` — AGENTS-FORK.md and openspec/config.yaml templates used in Phase 4 / Phase 5
...
Do not create agents speculatively. Wait until a repetitive pattern emerges (3+ identical task structures during the upgrade) and then extract per the **Automation extraction rule** in `AGENTS-FORK.md`. Examples that may surface:
...
- `AGENTS-FORK.md` exists and references the right docs
- `CLAUDE.md` imports both `@AGENTS.md` and `@AGENTS-FORK.md`
...
| 5. Set up Claude tooling | reviews AGENTS-FORK.md content | drafts AGENTS-FORK.md and agent/skill files |
